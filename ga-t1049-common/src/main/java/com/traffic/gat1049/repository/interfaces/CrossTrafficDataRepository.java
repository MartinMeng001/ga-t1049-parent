 ...
 */
@Repository
public interface CrossTrafficDataRepository extends BaseMapper<CrossTrafficDataEntity> {
    ...
    List<CrossTrafficDataEntity> findByTimeRange(@Param("crossId") String crossId,
    ...
    List<CrossTrafficDataEntity> findLatestData(@Param("crossId") String crossId, @Param("limit") Integer limit);
    ...
    List<CrossTrafficDataEntity> findByLane(@Param("crossId") String crossId,
    ...
    @Insert("<script>" +
            ...
            "</foreach>" +
            "</script>")
    int batchInsert(@Param("dataList") List<CrossTrafficDataEntity> dataList);
}
