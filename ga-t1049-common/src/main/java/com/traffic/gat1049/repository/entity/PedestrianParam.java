...
public class PedestrianParam {
    ...
    public PedestrianParam(String crossId, Integer pedestrianNo) {
        super();
        this.crossId = crossId;
        this.pedestrianNo = pedestrianNo;
    }

    public PedestrianParam(String crossId, Integer pedestrianNo, String direction) {
        super();
        this.crossId = crossId;
        this.pedestrianNo = pedestrianNo;
    ...
    public PedestrianParam(String crossId, Integer pedestrianNo, String direction, Integer attribute) {
        super();
        this.crossId = crossId;
        this.pedestrianNo = pedestrianNo;
        this.direction = direction;
    ...
    public boolean equals(Object o) {
        ...
        PedestrianParam that = (PedestrianParam) o;
